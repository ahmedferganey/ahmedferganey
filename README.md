<h1 align="center">Ahmed Ferganey | LLM Engineer</h1>
<h3 align="center">
AI Backend Engineer • RAG Systems • AI Agents • Scalable LLM Infrastructure • FastAPI • Kubernetes
</h3>

<p align="center">
  <a href="mailto:ahmed.ferganey707@gmail.com">📧 Email</a> •
  <a href="https://www.linkedin.com/in/ahmed-ferganey/">💼 LinkedIn</a> •
  <a href="https://github.com/ahmedferganey">🔗 GitHub</a> •
  <a href="https://hub.docker.com/u/ahmedferganey">🐳 Docker Hub</a>
</p>

---

## 🔍 Keywords (for Recruiters & Search Engines)
...
✅ **Agentic AI Systems** — Multi-agent orchestration with LangGraph, tool usage, and autonomous reasoning  
✅ **RAG Pipelines** — Multi-step retrieval, query decomposition, and embeddings-based search  
✅ **Scalable FastAPI Services** — Async processing, distributed task queues, and low-latency inference  
✅ **Production Infrastructure** — PostgreSQL, vector databases (pgvector, Qdrant), message brokers (RabbitMQ)  
✅ **Observability** — Prometheus, Grafana, monitoring, and alerting for distributed AI systems  
...
- Embedded Systems experience → production reliability mindset
- Industrial engineering background → process optimization and quality focus
...
🏆 **Ranked 5th out of 120** in the Mechanical Engineering Department
...
**🔗 [GitHub Repository](https://github.com/ahmedferganey/multi-agent-llm)**

Advanced multi-agent LLM pipeline demonstrating production-grade agentic architecture:

**Key Features:**
- **5-Agent Pipeline:** Planner → Researcher → Writer → Critic → Finalizer
...
**🔗 [GitHub Repository](https://github.com/ahmedferganey/async-rag-system)**
...
**🔗 [GitHub Repository](https://github.com/ahmedferganey/edge-whisper-stt)**
...
**🔗 [GitHub Repository](https://github.com/ahmedferganey/transfer-learning-cv)**
...
**🔗 [GitHub Repository](https://github.com/ahmedferganey/bilingual-spam-classifier)**
...
**🔗 [GitHub Repository](https://github.com/ahmedferganey/customer-segmentation-ml)**
...
**🔗 [GitHub Repository](https://github.com/ahmedferganey/ecu-embedded-stack)**

Full embedded software stack for AVR microcontrollers:

**Architecture:**
- **Layered Design:** MCAL → HAL → Service → Application
...
**🔗 [GitHub Repository](https://github.com/ahmedferganey/6dof-robotic-arm)** *(Graduation Project)*
...
- 📧 **Email:** [ahmed.ferganey707@gmail.com](mailto:ahmed.ferganey707@gmail.com)
- 💼 **LinkedIn:** [linkedin.com/in/ahmed-ferganey](https://www.linkedin.com/in/ahmed-ferganey/)
- 🔗 **GitHub:** [github.com/ahmedferganey](https://github.com/ahmedferganey)
- 🐳 **Docker Hub:** [docker.com/u/ahmedferganey](https://hub.docker.com/u/ahmedferganey)
...
<p align="center">
  <i>Building the future of AI-powered systems, one microservice at a time.</i>
</p>
